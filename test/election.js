...
contract("Election", function(accounts){
    ...
    it("it initializes the candidates with the correct values", function() {
        return Election.deployed().then(function(instance) {
          ...
          assert.equal(candidate.voteCount.toNumber(), 0, "contains the correct votes count");
          ...
          return electionInstance.candidates(3);
            ...
            assert.equal(candidate.id.toNumber(), 3, "contains the correct id");
            assert.equal(candidate.name, "Candidate 3", "contains the correct name");
            assert.equal(candidate.voteCount.toNumber(), 0, "contains the correct votes count");
        });
    });
